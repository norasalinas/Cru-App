...
public class EditCourseActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditCourseActivity.this, "ACTUALIZAR CURSO..", Toast.LENGTH_SHORT).show();
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        ...
                        Toast.makeText(EditCourseActivity.this, "ERROR A LA ACTUALIZACION DEL CURSO..", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void deleteCourse() {
        ...
        Toast.makeText(this, "CURSO BORRADO..", Toast.LENGTH_SHORT).show();
