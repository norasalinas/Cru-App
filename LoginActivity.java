        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email) && TextUtils.isEmpty(password)) {
                    Toast.makeText(LoginActivity.this, "INGRESE LA INFORMACIÓN..", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginActivity.this, "INICIO DE SESIÓN EXISTOSA..", Toast.LENGTH_SHORT).show();
                            ...
                            loadingPB.setVisibility(View.GONE);
                            Toast.makeText(LoginActivity.this, "INGRESE USUARIOS VALIDOS..", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
